      ...
      <div className="relative" style={{ width: '280px', height: '280px' }}>
        ...
        >
          ...
          <svg viewBox="0 0 280 280" className="absolute inset-0 w-full h-full opacity-30">
            {/* North America */}
            <path
              d="M60 80 Q70 60 90 65 Q100 70 95 85 Q90 95 80 100 Q70 95 65 90 Z"
              fill="rgba(34, 197, 94, 0.4)"
            />
            {/* South America */}
            <path
              d="M85 130 Q95 125 100 140 Q105 160 95 180 Q85 190 80 175 Q75 160 78 145 Z"
              fill="rgba(34, 197, 94, 0.4)"
            />
            {/* Europe */}
            <path
              d="M130 70 Q145 65 155 75 Q160 85 150 90 Q140 85 135 80 Z"
              fill="rgba(34, 197, 94, 0.4)"
            />
            {/* Africa */}
            <path
              d="M135 100 Q150 95 160 110 Q165 130 155 150 Q145 160 135 145 Q125 130 128 115 Z"
              fill="rgba(34, 197, 94, 0.4)"
            />
            {/* Asia */}
            <path
              d="M165 60 Q190 55 210 70 Q220 85 215 100 Q200 110 185 105 Q170 95 165 80 Z"
              fill="rgba(34, 197, 94, 0.4)"
            />
            {/* Australia */}
            <path
              d="M200 140 Q215 135 220 145 Q225 155 215 160 Q205 155 200 150 Z"
              fill="rgba(34, 197, 94, 0.4)"
            />
            {/* Grid lines */}
        ...
        >
          ...
          >
            <Plane className="w-4 h-4 text-blue-400" style={{ filter: 'drop-shadow(0 0 6px rgba(59, 130, 246, 0.6))' }} />
          </div>
        </div>

        {/* Plane 2 - Counter-clockwise orbit */}
        <div
          className="absolute"
          style={{
            width: '360px',
        ...
        >
          ...
          >
            <Plane className="w-3.5 h-3.5 text-cyan-400" style={{ filter: 'drop-shadow(0 0 6px rgba(34, 211, 238, 0.6))' }} />
          </div>
        </div>
      </div>
